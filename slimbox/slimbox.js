	...
	*/
    ...
    $.slimbox = function (_images, startImage, _options) {
        options = $.extend({
            ...
            initialHeight: 1200,			// Initial height of the box (in pixels)
	...
	*/
    ...
    function changeImage(imageIndex) {
        if (imageIndex >= 0) {
            ...
            // alert('width:'+preload.width+',height:'+preload.height);
    ...
    function animateBox() {
        ...
        if (preload.width > win.width()) {
            centerWidth = win.width() - 80;
            var bl = centerWidth/preload.width;
            centerHeight = preload.height * bl;
        } else {
